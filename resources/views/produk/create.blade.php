...
@section('content')
    ...
    <form method="POST" action="{{ route('produk.store') }}" novalidate autocomplete="off">
      ...
      <div class="fld">
        ...
        <input
          ...
          placeholder="Masukkan Ukuran Produk (mis: S, M, L)"
          value="{{ old('ukuran') }}"
          autocomplete="off" autocapitalize="off" autocorrect="off" spellcheck="false" inputmode="text"
          data-no-suggest
        >
  ...
  <style>
    ...
    .box form .fld:nth-of-type(1){ animation-delay:.22s }
    .box form .fld:nth-of-type(2){ animation-delay:.28s }
    .box form .fld:nth-of-type(3){ animation-delay:.34s }
    .box form .fld:nth-of-type(4){ animation-delay:.40s }
    .box form .fld:nth-of-type(5){ animation-delay:.46s }
